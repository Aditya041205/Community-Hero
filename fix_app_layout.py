...
replacement2 = """                                </AnimatePresence>
                          ...
                          <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-3xl p-5 flex flex-col h-[500px] lg:h-auto overflow-hidden">
